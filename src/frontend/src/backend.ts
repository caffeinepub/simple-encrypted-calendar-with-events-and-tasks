...
import type { EncryptedTask as _EncryptedTask, TaskId as _TaskId, Timestamp as _Timestamp, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addEvent(arg0: Timestamp, arg1: Timestamp, arg2: string, arg3: string): Promise<EventId> {
        if (this.processError) {
            try {
                const result = await this.actor.addEvent(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addTask(arg0: Timestamp | null, arg1: string, arg2: string): Promise<TaskId> {
        if (this.processError) {
            try {
                const result = await this.actor.addTask(to_candid_opt_n1(this._uploadFile, this._downloadFile, arg0), arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async clearAllDataForCaller(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearAllDataForCaller();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async clearAllDataForUser(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearAllDataForUser(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEvents(): Promise<Array<EncryptedEvent>> {
        if (this.processError) {
            try {
    ...
    async getTasks(): Promise<Array<EncryptedTask>> {
        if (this.processError) {
            try {
    ...
    async updateTaskStatus(arg0: TaskId, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_EncryptedTask_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _EncryptedTask): EncryptedTask {
...
function from_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        deadline: record_opt_to_undefined(from_candid_opt_n10(_uploadFile, _downloadFile, value.deadline)),
        encryptedDetails: value.encryptedDetails,
...
function from_candid_vec_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_EncryptedTask>): Array<EncryptedTask> {
    return value.map((x)=>from_candid_EncryptedTask_n8(_uploadFile, _downloadFile, x));
}
...
function to_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Timestamp | null): [] | [_Timestamp] {
